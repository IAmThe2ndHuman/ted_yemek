...
class DebugModal extends StatelessWidget {
  ...
  const DebugModal({super.key, required this.menuRepository, required this.menuCubit});
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ElevatedButton(
              onPressed: () async => ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text((await menuRepository.menuCacheValid).toString()))),
